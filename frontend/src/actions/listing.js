...
export const listListings = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:5000/api/listings/`, config)
...
export const deleteTask = (id) => async (dispatch, getState) => {
    try {
        ...
        const {data} = await axios.delete(
            `http://localhost:5000/api/listings/delete/${id}/`,
            config
        )
...
export const updateTask = (id, obj) => async (dispatch, getState) => {
    try {
        ...
        const {data} = await axios.put(
            `http://localhost:5000/api/listings/update/${id}/`,
            obj,
            config
        )
