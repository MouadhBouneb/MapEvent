...
const HomeScreen = ({ history }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const obj = {
      ...
      image:
        "https://media.spacebase.com/media/cache/spaces/12008/10_szGxH8p_1280.jpg",
      sector: sectorAdmin,
      userId: userInfo._id,
    };
  ...
  }, [userInfo, error, dispatch, successCreate, successDelete]);

  return (
    <>
      {userInfo && (
        <div className=" mt-5 d-flex justify-content-between" style={{marginLeft:'130px',marginRight:'130px'}}>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Modal.Body>
            ...
            <Form.Check
              ...
              type="radio"
              value="public"
              checked={sectorAdmin === "public"}
              onChange={(e) => setSectorAdmin(e.target.value)}
            />
            <Form.Check
              inline
              label="Private"
